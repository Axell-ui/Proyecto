...
const rewardConfig = {
  volcania: {
    ...
    description: 'Desbloquea la habilidad de recordar patrones ardientes con precisión infernal',
  ...
  neural: {
    ...
    description: 'Conexiones neuronales potenciadas para memoria instantánea',
  ...
  verdalis: {
    name: 'Verdalis',
    power: 'Sabiduría Ancestral',
    description: 'La memoria de mil años fluye a través de ti',
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <div className="bg-gray-800/50 rounded-2xl p-6 backdrop-blur-sm border border-gray-700">
              <div className="text-4xl mb-2" style={{ color: reward.glowColor }}>⭐⭐⭐</div>
              <div className="text-sm text-gray-400">Maestría</div>
            </div>
            <div className="bg-gray-800/50 rounded-2xl p-6 backdrop-blur-sm border border-gray-700">
