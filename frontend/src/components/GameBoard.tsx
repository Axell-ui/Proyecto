  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${config.bgGradient} relative overflow-hidden`}>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="grid gap-2 max-w-2xl mx-auto" style={{ gridTemplateColumns: `repeat(${Math.min(6, Math.ceil(Math.sqrt(cardCount)))}, minmax(0, 1fr))` }}>
